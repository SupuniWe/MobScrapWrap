...
public class GlobalClass extends Application {
    ...
    public static final String PATH_POSTS = "posts_set";
    ...
    public static final String TYPE_GARBAGE_POST = "garbage";
    public static final String TYPE_COMMUNITY_POST = "community";
