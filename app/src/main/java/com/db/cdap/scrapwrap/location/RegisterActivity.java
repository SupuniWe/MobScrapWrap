...
import com.db.cdap.scrapwrap.CategoryActivity;
...
public class RegisterActivity extends AppCompatActivity {
                        ...
                        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull final Task<AuthResult> task) {
                                if(task.isSuccessful())
                                {
                                    ...
                                    //Checks if the image has been uploaded or not
                                    user_profile.putFile(imageUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                        @Override
                                        public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> uploadTask) {
                                            if(uploadTask.isSuccessful())
                                            {
                                                final UploadTask.TaskSnapshot download_url = uploadTask.getResult();
    ...
    private void sendToMain() {
        Intent mainIntent = new Intent(RegisterActivity.this, CategoryActivity.class);
