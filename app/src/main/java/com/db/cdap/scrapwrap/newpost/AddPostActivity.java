...
import com.db.cdap.scrapwrap.community.Posts;
...
import com.db.cdap.scrapwrap.utils.MultipartRequest;
import com.db.cdap.scrapwrap.utils.PermissionUtils;
...
import static com.db.cdap.scrapwrap.utils.GlobalClass.URL_CHECK_SCRAPS;
...
public class AddPostActivity extends AppCompatActivity {
    ...
    Button btnAddPostToCommunity;
    TextView txtAddPostImageDetails;
    TextInputEditText txtAddPostDescription;
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        btnAddPostToCommunity = findViewById(R.id.btnAddPostToCommunity);
        txtAddPostDescription = findViewById(R.id.txtAddPostDescription);
        ...
        btnAddPostToCommunity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showCleanerDialog();
            }
        ...
        btnAddPostCheckImage.setEnabled(false);
        btnAddPostToCommunity.setEnabled(false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        btnAddPostCheckImage.setEnabled(true);
    ...
    private void addToCommunity() {
        if(txtAddPostDescription.getText() != null){
            String description = txtAddPostDescription.getText().toString().trim();
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < 5; i++) {
                                    ...
                                    String className = object.getString("class").toUpperCase();
                            ...
                            if (scrapAvailable) {
//                                showCleanerDialog();
                                btnAddPostToCommunity.setEnabled(true);
                            } else {
    ...
    private void showCleanerDialog() {
        ...
        cleanerDialog.setNeutralButton(getString(R.string.post_to_community), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
